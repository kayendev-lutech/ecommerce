...
export class CreateProductAttributeValues1755663698002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create indexes
        await queryRunner.query(`CREATE INDEX "IDX_product_attr_values_product_id" ON "product_attribute_values" ("product_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_product_attr_values_attribute_id" ON "product_attribute_values" ("category_attribute_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_product_attr_values_option_id" ON "product_attribute_values" ("category_attribute_option_id")`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_attribute_values" DROP CONSTRAINT "FK_product_attr_values_option_id"`);
        await queryRunner.query(`ALTER TABLE "product_attribute_values" DROP CONSTRAINT "FK_product_attr_values_attribute_id"`);
        await queryRunner.query(`ALTER TABLE "product_attribute_values" DROP CONSTRAINT "FK_product_attr_values_product_id"`);
