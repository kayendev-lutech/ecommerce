...
export class CreateVariantAttributeValues1755663753140 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create indexes
    await queryRunner.query(
      `CREATE INDEX "IDX_variant_attr_values_variant_id" ON "variant_attribute_values" ("variant_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_variant_attr_values_attribute_id" ON "variant_attribute_values" ("category_attribute_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_variant_attr_values_option_id" ON "variant_attribute_values" ("category_attribute_option_id")`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" DROP CONSTRAINT "FK_variant_attr_values_option_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" DROP CONSTRAINT "FK_variant_attr_values_attribute_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" DROP CONSTRAINT "FK_variant_attr_values_variant_id"`,
    );
